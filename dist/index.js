...
var css = "/* add css styles here (optional) */\n\n\n\n.styles_test__32Qsm {\n  display: inline-block;\n  margin: 2em auto;\n  font-size: 2em;\n}\n\n.styles_test1__3q7XI {\n    border: 2px solid #7df756;\n}\n\n.styles_filterButton__3xfyW {\n    float: right;\n}\n\n.styles_transparentButton__2sW-M {\n    background-color: Transparent;\n    background-repeat:no-repeat;\n    border: none;\n}\n\n.styles_activeFilter__1xMkD {\n    color: #009f13;\n}\n.styles_tableContainer__fjLYp {\n    position: static;\n}\n";
var styles = { "test": "styles_test__32Qsm", "test1": "styles_test1__3q7XI", "filterButton": "styles_filterButton__3xfyW", "transparentButton": "styles_transparentButton__2sW-M", "activeFilter": "styles_activeFilter__1xMkD", "tableContainer": "styles_tableContainer__fjLYp" };
styleInject(css);
...
var ExampleComponent1 = function (_Component) {
  inherits(ExampleComponent1, _Component);

  function ExampleComponent1() {
    classCallCheck(this, ExampleComponent1);
    return possibleConstructorReturn(this, (ExampleComponent1.__proto__ || Object.getPrototypeOf(ExampleComponent1)).apply(this, arguments));
  }

  createClass(ExampleComponent1, [{
    key: 'render',
    value: function render() {
      ...
      return React__default.createElement(
        'div',
        { className: [styles.test, styles.test1].join(' ') },
        'Example11111 Component: ',
        text
      );
    }
  }]);
...
var getStyle = function getStyle(styleFunc, props) {
    if (styleFunc) {
...
var renderHeaderCell = function renderHeaderCell(Renderer, funcRenderer, tableData, headerInfo) {
    if (Renderer) {
        return React__default.createElement(Renderer, { tableData: tableData.tableData, headerInfo: headerInfo });
...
var renderCell = function renderCell(Renderer, funcRenderer, tableData, rowData, columnId) {
    ...
    if (Renderer) {
        ...
        return React__default.createElement(Renderer, { tableData: tableData.tableData, rowData: rowData, columnId: columnId });
    } else if (funcRenderer) {
...
function normalizeIconArgs(icon$$1) {
  ...
  if (_typeof$2(icon$$1) === 'object' && icon$$1.prefix && icon$$1.iconName) {
    return icon$$1;
...
var HeaderCell = function (_Component) {
    inherits(HeaderCell, _Component);
    ...
    function HeaderCell() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = HeaderCell.__proto__ || Object.getPrototypeOf(HeaderCell)).call.apply(_ref, [this].concat(args))), _this), _this.getFilterIcon = function () {
            var buttonClassName = [styles.filterButton, styles.transparentButton];
            if (_this.props.columnFilter !== undefined && _this.props.columnFilter.filteredValues.length > 0) {
            ...
            if (_this.props.serviceTableData.tableData.filterActive) {
                return React__default.createElement(
                    ...
                    React__default.createElement(FontAwesomeIcon, { icon: faFilter })
                );
            }
...
var HeaderRow = function (_Component) {
    ...
    function HeaderRow() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = HeaderRow.__proto__ || Object.getPrototypeOf(HeaderRow)).call.apply(_ref, [this].concat(args))), _this), _this.toggleFilter = function (x, y, columnId) {
            _this.props.toggleFilter(x, y, columnId);
        }, _temp), possibleConstructorReturn(_this, _ret);
    }
...
var Cell = function (_Component) {
    ...
    function Cell() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Cell.__proto__ || Object.getPrototypeOf(Cell)).call.apply(_ref, [this].concat(args))), _this), _this.getGroupButtonStyle = function () {
            return {
            ...
            return React__default.createElement(
                ...
                React__default.createElement(FontAwesomeIcon, { icon: _this.getGroupButtonIcon() })
            );
        }, _temp), possibleConstructorReturn(_this, _ret);
    }
    ...
    function Row() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Row.__proto__ || Object.getPrototypeOf(Row)).call.apply(_ref, [this].concat(args))), _this), _this.getRow = function () {
            ...
            if (rowDataInfo.filtered) {
                ...
                return React__default.createElement(React__default.Fragment, { key: rowData.id });
            }
        }, _temp), possibleConstructorReturn(_this, _ret);
    }
...
var ColumnFilter = function (_Component) {
    inherits(ColumnFilter, _Component);
    ...
    function ColumnFilter() {
        ...
        classCallCheck(this, ColumnFilter);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ColumnFilter.__proto__ || Object.getPrototypeOf(ColumnFilter)).call.apply(_ref, [this].concat(args))), _this), _this.getStyle = function (left, top) {
            return {
                left: left,
                top: top,
                display: 'inline',
        ...
        }, _this.getColumnFilterListStyle = function () {
            return {
                maxHeight: '500px',
                overflow: 'auto'
            };
    ...
    createClass(ColumnFilter, [{
        ...
        value: function render() {
            ...
            if (this.props.columnFilter.isFilterActive) {
                ...
                var values = Object.keys(valueRenderedValueMap).map(function (value) {
                    var renderedValue = valueRenderedValueMap[value].renderedValue;
                    var isChoosen = _this2.props.columnFilter.filteredValues.includes(value);
                    return React__default.createElement(
                        'div',
                        { key: value },
                        React__default.createElement('input', {
                            ...
                            onChange: function onChange() {
                                _this2.props.toggleFilterRow(_this2.props.columnFilter.columnId, value);
                            }
                        }),
                        renderedValue
                    );
                ...
                return React__default.createElement(
                    ...
                    { onClick: function onClick(e) {
                            _this2.onFilterClick(e);
                        }, style: this.getStyle(this.props.columnFilter.mouseX.toString() + 'px', this.props.columnFilter.mouseY.toString() + 'px'), id: 'columnFilter' },
                    React__default.createElement(
                        'div',
                        { style: this.getColumnFilterListStyle() },
                        values
                    ),
                    React__default.createElement(
                        'button',
                        { className: styles.transparentButton, onClick: function onClick() {
                                _this2.props.closeColumnFilter(_this2.props.columnFilter.columnId);
                            } },
...
var Table$1 = function (_Component) {
    ...
    function Table(props) {
        ...
        _this.toggleFilterRow = function (colId, value, rowIdList) {
            var newState = _extends({}, _this.state, {});
        ...
        _this.closeColumnFilter = function (columnId) {
            var newState = _extends({}, _this.state, {});
            newState.columnFilter[columnId].isFilterActive = false;
            _this.setState(newState);
        };
    ...
    createClass(Table, [{
        ...
        key: 'generateColumnFilterState',
        value: function generateColumnFilterState(isFilterActive, filteredRows, x, y, columnId) {
            return {
                mouseX: x,
                mouseY: y,
        ...
        value: function render() {
            ...
            if (this.state.serviceTableData.data !== undefined) {
                ...
                var columnFilters = Object.keys(this.state.columnFilter).map(function (colId) {
                    return React__default.createElement(ColumnFilter, {
                        key: colId,
                ...
                var columnVisibilityContainer = React__default.createElement(ColumnVisibility$1, { tableData: this.state.serviceTableData, columnVisibility: this.state.columnVisibility, hideColumnVisibility: this.hideColumnVisibility });
                ...
                return React__default.createElement(
                    ...
                    React__default.createElement(MenuBar, { tableData: this.state.serviceTableData, toogleColumnVisibilityContainer: this.toogleColumnVisibilityContainer }),
                    React__default.createElement(
                        'table',
                        {
                        ...
                        React__default.createElement(HeaderRow, {
...
exports.ExampleComponent1 = ExampleComponent1;
