        ...
        value: function render() {
            ...
            if (columns !== undefined) {
                var headers = columns.map(function (headerInfo) {
                    ...
                    if (isColumnHidden) {
                        return React.createElement(React.Fragment, { key: headerInfo.field });
                    }
...
var Cell = function (_Component) {
    ...
    createClass(Cell, [{
        ...
        value: function render() {
            ...
            return React.createElement('td', { style: getStyle(this.props.tableData.defaultCellStyle, this.props) });
        }
    }]);
    return Cell;
}(Component);
    ...
    function Row() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Row.__proto__ || Object.getPrototypeOf(Row)).call.apply(_ref, [this].concat(args))), _this), _this.getRow = function () {
            ...
            if (_this.props.filteredRowIdList.includes(_this.props.rowDataId.toString())) {
                ...
                return React.createElement(React.Fragment, { key: rowData.id });
            }
        }, _temp), possibleConstructorReturn(_this, _ret);
    }
        ...
        value: function render() {
            ...
            if (tableData.data !== undefined) {
                ...
                var tbody = entryPointsList.map(function (id) {
                    var rowData = tableData.data[id];
                    return React.createElement(Row, { key: rowData.id, rowDataId: rowData.id, tableData: tableData, filteredRowIdList: _this4.state.filteredRowIdList, triggerRow: _this4.triggerRow });
                });
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(HeaderRow, { tableData: tableData, toggleFilter: this.toggleFilter, columnFilter: this.state.columnFilter }),
                        React.createElement(
                            'tbody',
                            null,
                            tbody
...
export { ExampleComponent, ExampleComponent1, Table$1 as Table };
